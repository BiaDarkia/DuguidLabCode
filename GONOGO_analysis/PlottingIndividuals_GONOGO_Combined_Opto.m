...
ax7 = subplot(m,n,7); 
PlotterTwoLines_opto(1, 2, [0, 0, numOptoDays,3000], median_reaction_time_Hit_OptoStim(mouse_ID ,:), median_reaction_time_Hit_NoStim(mouse_ID ,:), ...
...
PlotterTwoLines_opto(0, 2, [0, 0, numOptoDays,3000], median_reaction_time_FalseAlarm_OptoStim(mouse_ID ,:), median_reaction_time_FalseAlarm_NoStim(mouse_ID ,:), ...
