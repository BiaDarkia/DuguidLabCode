...
for file_ID=xlsList
    ...
    if exist('Lever_training_cued_metadata.mat','file')
        ...
        old_metadata={'Mouse_name','ABF_name','Initial_weight','Tr_day_1_date','Num_Tr_days'};
    end
    ...
    % metadata
    newmetadata     = {Mouse_name,ABF_name,Initial_weight,Tr_day_1_date,Num_tr_days};
    ...
    for day_ID = 1:Num_tr_days
        ...
        %%% Code below for spreadsheets of mice that were NOT water restricted for 10 days prior to start of training
