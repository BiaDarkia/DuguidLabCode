function PlotterHisto (m,n,l, RPos, HVar, HCol1, HCol2, HCol3, Pvar, PCol, ttl, xlbl, ylbl, Line_width, Width_lines, Mod2Start,num_days, rigRectPos)
% Create subplot
subplot(m,n,l); 
...
% Changing background for lever days; 
rectangle('Position', rigRectPos, 'FaceColor', [0.5 0.5 0.5], 'EdgeColor', [.6 .6 .6]);
